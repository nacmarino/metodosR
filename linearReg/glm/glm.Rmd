...
* Em ecologia: utilizado principalmente para modelar dados de abundância e/ou densidade.  
...
* Soluções:  
    ...
    3. Tentar outra distribuição estatística;  
    4. Transformar o dado original e usar a distribuição normal.  
  
* Mas a distribuição de Poisson pode ser útil!  

## GLM | Distribuição de Poisson  

* Em alguns casos, a distribuição ainda pode ser útil!
